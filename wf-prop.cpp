...
static int query_view_below_view(guint view_id) {
  GVariant *tmp = NULL;
  int value = 0;
...
static int query_view_above_view(guint view_id) {
  GVariant *tmp = NULL;
  int value = 0;
...
static gboolean query_view_minimized(guint view_id) {
  GError *error = NULL;
  GVariant *tmp = NULL;
  gboolean value;
...
static gboolean query_view_maximized(guint view_id) {
  GError *error = NULL;
  GVariant *tmp = NULL;
  gboolean value;
...
static gboolean query_view_fullscreen(guint view_id) {
  GError *error = NULL;
  GVariant *tmp = NULL;
  gboolean value;
...
static gboolean query_view_active(guint view_id) {
  GError *error = NULL;
  GVariant *tmp = NULL;
  gboolean value;
...
static uint query_view_xwayland_wid(uint view_id) {
  GError *error = NULL;
  GVariant *tmp = NULL;
  uint value = 0;
...
static void print_view_data(guint view_id) {
...
static GOptionEntry entries[] = {{"list", 'l', 0, G_OPTION_ARG_NONE, &list,
